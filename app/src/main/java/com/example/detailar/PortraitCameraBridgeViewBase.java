...
public abstract class PortraitCameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    // return Camera Index(FRONT / BACK)
    public int getCameraIndex() {
        return this.mCameraIndex;
    }

    // set Camera Index(FRONT / BACK)
    ...
    public void setMPreviewFormat(int color){
    ...
    protected class CvCameraViewListenerAdapter implements CvCameraViewListener2  {
        ...
        private int mPreviewFormat = RGBA; // Adapter RGBA
    ...
    public interface CvCameraViewFrame {
        public Mat rgba(); // RGBA

        public Mat gray(); // Gray
    };
